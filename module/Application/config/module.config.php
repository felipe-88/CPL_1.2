    ...
    'doctrine' => array(
        ...
        'authentication' => array(
            'orm_default' => array(
                ...
                'identity_class' => 'Application\Entity\Operador',
                'identity_property' => 'email',
                'credential_property' => 'senha',
                'credential_callable' => function(\Application\Entity\Operador $operador,
                $senha) {
            $bcrypt = new \Zend\Crypt\Password\Bcrypt();
            return $bcrypt->verify($senha, $operador->getSenha());
        }
            ),
        ),
    ),
        ...
        'routes' => array(
            ...
            'secretarias' => array(
                ...
                'options' => array(
                    ...
                    'defaults' => array(
                        'controller' => 'Application/Controller/Secretarias',
                        'action' => 'index',
                    ),
                ),
            ),
            ...
            'unidades' => array(
                ...
                'options' => array(
                    ...
                    'defaults' => array(
                        'controller' => 'Application/Controller/Unidades',
                        'action' => 'index',
                    ),
                ),
            ),
